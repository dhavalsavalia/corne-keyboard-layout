...
var (
	ColorFg        = lipgloss.AdaptiveColor{Light: "0", Dark: "15"}   // Black/White
	...
	ColorPurple    = lipgloss.Color("5")                              // Magenta/Purple
	ColorDim       = lipgloss.Color("8")                              // Bright black (gray)
	ColorBorder    = lipgloss.Color("8")                              // Gray for inactive
	ColorBorderAct = lipgloss.Color("5")                              // Purple for active
)
